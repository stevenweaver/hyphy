 ...
 * @param {AssociativeList} model_spec - a model specification, see MG_REV.ModelDescription as an example.
 * @param {String} id - the name of the model you are specifying
